        ...
        <>
            <div className='' >
                ...
                <p className='text-justify md:text-[15px] text-sm' >
                    ...
                    <br></br>
                    <br></br>
                    hoje, me encontro com mais de 1 ano de experiência profissional na área de Desenvolvedor. apesar da pouca experiência, já possuo alguns projetos pessoais que
